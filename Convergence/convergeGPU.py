...
def run_convergence_trials(max_resolution=50, min_resolution=5, step=2, num_trials=10, save_path="chern_convergence_gpu_512_results.csv"):
    """
...
if __name__ == "__main__":
    ...
    run_convergence_trials(max_resolution=65, min_resolution=15)
