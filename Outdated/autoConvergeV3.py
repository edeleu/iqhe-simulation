...
def helper(thetaRes, V):
    ...
    pctile = np.percentile(min_eigs,0.2,axis=1) # calculate lowest 20th percentile
...
def run_convergence_trials(max_resolution=50, min_resolution=5, step=2, num_trials=10000, save_path="chern_64_convergenceV3_results.csv"):
    """
...
if __name__ == "__main__":
    ...
    run_convergence_trials(max_resolution=60, min_resolution=10)
